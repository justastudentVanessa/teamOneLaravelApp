...
@section('title') Edit Course Details @stop
...
<div class='col-lg-4 col-lg-offset-4'>
    ...
    <h1><i class='fa fa-user'></i> Edit Course Details</h1>

    {{ Form::model($course, ['role' => 'form', 'url' => '/CourseDetailsTable/' . $details->id, 'method' => 'PUT']) }}
